...
"<form action='/restart' method='get'><button>重新启动</button></form><br/>\n",// MENU_RESTART
"<form action='/exit'    method='get'><button>退出</button></form><br/>\n",  // MENU_EXIT
"<form action='/erase'   method='get'><button class='D'>清除数据</button></form><br/>\n", // MENU_ERASE
...
const char HTTP_ITEM[]             PROGMEM = "<div><a href='#p' οnclick='c(this)'>{v}</a>{qi}{qp}</div>"; // {q} = HTTP_ITEM_QI, {r} = HTTP_ITEM_QP
// const char HTTP_ITEM[]            PROGMEM = "<div><a href='#p' οnclick='c(this)'>{v}</a> {R} {r}% {q} {e}</div>"; // test all tokens

const char HTTP_FORM_START[]       PROGMEM = "<form method='POST' action='{v}'>";
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>WiFi</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>密码</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'>";
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>保存信息<br/>ESP尝试去链接这个网络.<br />如果链接这个网络失败 请重试</div>";
const char HTTP_PARAMSAVED[]       PROGMEM = "<div class='msg S'>保存<br/></div>";
const char HTTP_END[]              PROGMEM = "</div></body></html>";
const char HTTP_ERASEBTN[]         PROGMEM = "<br/><form action='/erase' method='get'><button class='D'>清除Wifi数据</button></form>";
...
const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>链接上了哦~</strong> to {v}<br/><em><small>IP是 {i}</small></em></div>";
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>亲~连接失败</strong> to {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
...
"button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#f581a4;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%}"
"input[type='file']{border:1px solid #f581a4}"
".wrap {text-align:left;display:inline-block;min-width:260px;max-width:500px}"
// links
"a{color:#fff;font-weight:700;text-decoration:none}a:hover{color:#f581a4;text-decoration:underline}"
// quality icons
...
// msg callouts
".msg{padding:20px;margin:20px 0;border:1px solid #eee;border-left-width:5px;border-left-color:#777}.msg h4{margin-top:0;margin-bottom:5px}.msg.P{border-left-color:#f581a4}.msg.P h4{color:#f581a4}.msg.D{border-left-color:#dc3630}.msg.D h4{color:#dc3630}.msg.S{border-left-color: #5cb85c}.msg.S h4{color: #5cb85c}"
// lists
...
// invert
"body.invert,body.invert a,body.invert h1 {background-color:#93e5e6;color:#fff;}"
"body.invert .msg{color:#fff;background-color:#66a80f;border-top:1px solid #555;border-right:1px solid #555;border-bottom:1px solid #555;}"
...
const char S_brand[]              PROGMEM = "你可以在这里配置WiFi";
